...
const AP_Param::GroupInfo AP_Baro::var_info[] = {
    ...
    // @Bitmask: 0:BMP085,1:BMP280,2:MS5611,3:MS5607,4:MS5637,5:FBM320,6:DPS280,7:LPS25H,8:Keller,9:MS5837,10:BMP388,11:SPL006
    // @Values: 1:BMP085,2:BMP280,4:MS5611,8:MS5607,16:MS5637,32:FBM320,64:DPS280,128:LPS25H,256:Keller,512:MS5837,1024:BMP388,2048:SPL006
    // @User: Advanced
...
void AP_Baro::_probe_i2c_barometers(void)
{
    ...
    if (probe & PROBE_SPL006) {
        FOREACH_I2C_MASK(i,mask) {
            ADD_BACKEND(AP_Baro_SPL006::probe(*this,
                                              std::move(GET_I2C_DEVICE(i, HAL_BARO_SPL006_I2C_ADDR))));
            ADD_BACKEND(AP_Baro_SPL006::probe(*this,
                                              std::move(GET_I2C_DEVICE(i, HAL_BARO_SPL006_I2C_ADDR2))));
        }
    }
